...
This will go through creating a `KYCAgeCredential` credential based off the following [KYC Age Credential Schema](http://47.242.107.228:3003/schemas/json/KYCAgeCredential-v3.json)
